...
$block = join("|",array( "button","icon","list","list_item","list_checkmark","list_arrow","list_ace","list_unstyled","list_heading","list_inline","list_separator","text_color","dropcap","highlight","glyphicon_heading","icon_heading","feature_big_icon","feature_big_glyphicon","feature_small_icon","feature_small_glyphicon","person","overlay_image","box","spacer","divider","blockquote","tooltip","carousel-wrapper","carousel-item","image-item","table","tbody","thead","tr","th","td","pricing","pricing_column","table_head","table_content","pricing_features","pricing_list_item" ) );
// opening tag
 ...
 *
 *------------------------------------------------------------*/
// Heading with icon - bootstrap font icon
function tcsn_glyphicon_heading_sc( $atts, $content = null ) {
 ...
 return '<h4 class="heading-icon clearfix"><span class="glyphicon glyphicon-' . $icon_type . ' icon-bg" style="color: ' . $icon_color . ';"></span>' . do_shortcode( $content ) . '</h4>';
}
...
// [feature_big_glyphicon icon_type="bookmark" icon_color="#fff" heading="Heading here"]Content here[/feature_big_glyphicon]
// [feature_small_glyphicon icon_type="bookmark" icon_color="#fff" heading="Heading here"]Content here[/feature_small_glyphicon]
 *
 *------------------------------------------------------------*/
...
// Features with big center glyphicon
function tcsn_feature_big_glyphicon_sc( $atts, $content = null ) {
 ...
 return '<div class="feature-big-icon"><span class="glyphicon glyphicon-' . $icon_type . ' icon-big-bg" style="color: ' . $icon_color . ';"></span><h2>' . $heading . '</h2>' . do_shortcode( $content ) . '</div>';
}
...
function tcsn_feature_small_glyphicon_sc( $atts, $content = null ) {
 ...
 return '<div class="feature-small-icon"><h5><span class="glyphicon glyphicon-' . $icon_type . '" style="color: ' . $icon_color . ';"></span>' . $heading . '</h5>' . do_shortcode( $content ) . '</div>';
}  	  
