 ...
 *
 * The Template for displaying 4 column portfolio
 *
 * @package WordPress
 * @subpackage Grepfrut
 * @since Grepfrut 1.0
        ...
        <div class="row">
            ...
            <div id="items" class="filter-content">
                ...
                <?php
					...
					$tax = ''; ?>
                <?php endif; ?>
                <div class="col-md-3 col-sm-3 col-xs-12 item <?php echo strtolower($tax); ?> all">
                    <?php 
                    ...
                    <?php 
						...
						case 'Image': ?>
                    <div class="folio-thumb"> <a href="<?php echo $lightbox_image_url[0];?>" rel="prettyPhoto[gallery]" class="icon-zoom" title="<?php echo $zoom_title; ?>"></a>
                        <?php if ( $external_link == 1 ) { ?>
                        <a href="<?php echo $link_url; ?>" class="icon-link"></a>
                        <?php } else { ?>
                    ...
                    <?php break; // end image ?>
                    <?php case 'Video': ?>
                    <div class="folio-thumb"> <a href="<?php echo $video_url; ?>" rel="prettyPhoto[gallery]" class="icon-zoom" title="<?php echo $zoom_title; ?>"></a>
                        <?php if ( $external_link == 1 ) { ?>
                        <a href="<?php echo $link_url; ?>" class="icon-link"></a>
                        <?php } else { ?>
                        <a href="<?php the_permalink(); ?>" class="icon-link"></a>
