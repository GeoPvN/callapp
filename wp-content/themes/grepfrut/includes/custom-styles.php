...
function tcsn_custom_styles() {
	...
	$tcsn_top_margin_logo = $smof_data['tcsn_top_margin_logo'];
	
	$tcsn_phone_face  = $smof_data['tcsn_font_phone']['face'];
	$tcsn_phone_size  = $smof_data['tcsn_font_phone']['size'];
	$tcsn_phone_style = $smof_data['tcsn_font_phone']['style'];
	$tcsn_phone_color = $smof_data['tcsn_font_phone']['color'];
	
	$tcsn_tagline_face  = $smof_data['tcsn_font_tagline']['face'];
	$tcsn_tagline_size  = $smof_data['tcsn_font_tagline']['size'];
	$tcsn_tagline_style = $smof_data['tcsn_font_tagline']['style'];
	$tcsn_tagline_color = $smof_data['tcsn_font_tagline']['color'];
	...
	$tcsn_menu_link_color = $smof_data['tcsn_menu_link_color'];
	$tcsn_bg_color_hover_menu = $smof_data['tcsn_bg_color_hover_menu']; 
	$tcsn_bg_color_dropdown_menu = $smof_data['tcsn_bg_color_dropdown_menu']; 
	$tcsn_link_hover_dropdown = $smof_data['tcsn_link_hover_dropdown']; 
	$tcsn_bg_color_topbar = $smof_data['tcsn_bg_color_topbar'];  
	
	// Header bottom
	$tcsn_header_btm_face = $smof_data['tcsn_font_header_btm']['face'];
	$tcsn_header_btm_size = $smof_data['tcsn_font_header_btm']['size'];
	$tcsn_header_btm_style = $smof_data['tcsn_font_header_btm']['style'];
	$tcsn_header_btm_color = $smof_data['tcsn_font_header_btm']['color'];
	$tcsn_top_margin_breadcrumb = $smof_data['tcsn_top_margin_breadcrumb']; 
	$tcsn_link_color_header_btm = $smof_data['tcsn_link_color_header_btm']; 
	$tcsn_link_hover_header_btm = $smof_data['tcsn_link_hover_header_btm']; 
	$tcsn_color_active_breadcrumb = $smof_data['tcsn_color_active_breadcrumb']; 
	$tcsn_border_bottom_headerbtm = $smof_data['tcsn_border_bottom_headerbtm'];
	$tcsn_title_face  = $smof_data['tcsn_font_title']['face'];
	$tcsn_title_size  = $smof_data['tcsn_font_title']['size'];
	$tcsn_title_style = $smof_data['tcsn_font_title']['style'];
	$tcsn_title_color = $smof_data['tcsn_font_title']['color'];
	...
	// Copyright
	$tcsn_copyright_face  = $smof_data['tcsn_font_copyright']['face'];
	$tcsn_copyright_size  = $smof_data['tcsn_font_copyright']['size'];
	$tcsn_copyright_style = $smof_data['tcsn_font_copyright']['style'];
	$tcsn_copyright_color = $smof_data['tcsn_font_copyright']['color'];
	$tcsn_bg_color_copyright = $smof_data['tcsn_bg_color_copyright'];
	$tcsn_link_color_copyright = $smof_data['tcsn_link_color_copyright'];
	$tcsn_link_hover_copyright = $smof_data['tcsn_link_hover_copyright'];
	$tcsn_border_top_copyright = $smof_data['tcsn_border_top_copyright'];
	...
	$tcsn_icon_bg = $smof_data['tcsn_icon_bg'];
	$tcsn_twitter_box_bg = $smof_data['tcsn_bg_color_twitter_box'];
	$tcsn_twitter_box_border = $smof_data['tcsn_border_color_twitter_box'];
	$tcsn_blockquote_color = $smof_data['tcsn_blockquote_color'];
	$tcsn_button_face  = $smof_data['tcsn_font_button']['face'];
	$tcsn_button_style = $smof_data['tcsn_font_button']['style'];
	$tcsn_tag_bg_color = $smof_data['tcsn_tag_bg_color']; 
	$tcsn_pricing_color = $smof_data['tcsn_pricing_color']; 
	$tcsn_pattern_slider_bg = $smof_data['tcsn_pattern_slider_bg']; 
...
{$tcsn_menu_size}; font-weight: {$tcsn_menu_style}; color: {$tcsn_menu_color}; }
...
#slider-bg { background-image: url( <?php echo $smof_data['tcsn_pattern_slider_bg'] ?> ); background-color: <?php echo $smof_data['tcsn_color_slider_bg'] ?>; }
