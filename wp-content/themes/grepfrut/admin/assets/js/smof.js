...
jQuery(document).ready(function($){
	...
	//Color schemes start here

	// Cyan
    var cyan = new Array();
	cyan['tcsn_font_logo_color']='#44b1d9';
	cyan['tcsn_hover_logo']='#44b1d9';
	cyan['tcsn_link_hover_header_btm']='#44b1d9';
	cyan['tcsn_link_color']='#44b1d9';
	cyan['tcsn_icon_bg']='#44b1d9';
	cyan['tcsn_page_link_bg']='#44b1d9';
	cyan['tcsn_blockquote_color']='#44b1d9';
	cyan['tcsn_tag_bg_color']='#44b1d9';
	cyan['tcsn_pricing_color']='#44b1d9';
	cyan['tcsn_text_color']='#44b1d9';
	cyan['tcsn_menu_link_color']='#44b1d9';
   
   // Green
    var green = new Array();
	green['tcsn_font_logo_color']='#8eb943';
	green['tcsn_hover_logo']='#8eb943';
	green['tcsn_link_hover_header_btm']='#8eb943';
	green['tcsn_link_color']='#8eb943';
	green['tcsn_icon_bg']='#8eb943';
	green['tcsn_page_link_bg']='#8eb943';
	green['tcsn_blockquote_color']='#8eb943';
	green['tcsn_tag_bg_color']='#8eb943';
	green['tcsn_pricing_color']='#8eb943';
	green['tcsn_text_color']='#8eb943';
	green['tcsn_menu_link_color']='#8eb943';

    // Orange
	var orange = new Array();
	orange['tcsn_font_logo_color']='#d95b44';
	orange['tcsn_hover_logo']='#d95b44';
	orange['tcsn_link_hover_header_btm']='#d95b44';
	orange['tcsn_link_color']='#d95b44';
	orange['tcsn_icon_bg']='#d95b44';
	orange['tcsn_page_link_bg']='#d95b44';
	orange['tcsn_blockquote_color']='#d95b44';
	orange['tcsn_tag_bg_color']='#d95b44';
	orange['tcsn_pricing_color']='#d95b44';
	orange['tcsn_text_color']='#d95b44';
	orange['tcsn_menu_link_color']='#d95b44';

	// Purple	
	var purple = new Array();
	purple['tcsn_font_logo_color']='#8a44d9';
	purple['tcsn_hover_logo']='#8a44d9';
	purple['tcsn_link_hover_header_btm']='#8a44d9';
	purple['tcsn_link_color']='#8a44d9';
	purple['tcsn_icon_bg']='#8a44d9';
	purple['tcsn_page_link_bg']='#8a44d9';
	purple['tcsn_blockquote_color']='#8a44d9';
	purple['tcsn_tag_bg_color']='#8a44d9';
	purple['tcsn_pricing_color']='#8a44d9';
	purple['tcsn_text_color']='#8a44d9';
	purple['tcsn_menu_link_color']='#8a44d9';
		
	// Red
	var red = new Array();
	red['tcsn_font_logo_color']='#d9444f';
	red['tcsn_hover_logo']='#d9444f';
	red['tcsn_link_hover_header_btm']='#d9444f';
	red['tcsn_link_color']='#d9444f';
	red['tcsn_icon_bg']='#d9444f';
	red['tcsn_page_link_bg']='#d9444f';
	red['tcsn_blockquote_color']='#d9444f';
	red['tcsn_tag_bg_color']='#d9444f';
	red['tcsn_pricing_color']='#d9444f';
	red['tcsn_text_color']='#d9444f';
	red['tcsn_menu_link_color']='#d9444f';
	
	// Yellow
	var yellow = new Array();
    yellow['tcsn_font_logo_color']='#d9b444';
	yellow['tcsn_hover_logo']='#d9b444';
	yellow['tcsn_link_hover_header_btm']='#d9b444';
	yellow['tcsn_link_color']='#d9b444';
	yellow['tcsn_icon_bg']='#d9b444';
	yellow['tcsn_page_link_bg']='#d9b444';
	yellow['tcsn_blockquote_color']='#d9b444';
	yellow['tcsn_tag_bg_color']='#d9b444';
	yellow['tcsn_pricing_color']='#d9b444';
	yellow['tcsn_text_color']='#d9b444';
	yellow['tcsn_menu_link_color']='#d9b444';

    // When the select box #tcsn_color_scheme changes
    // it checks which value was selected and calls of_update_color
    $('#tcsn_color_scheme').change(function() {
        colorscheme = $(this).val();
	
		if (colorscheme == 'cyan') { colorscheme = cyan; }
    ...
    function of_update_color(id,hex) {
    	$('#' + id + '.of-color').wpColorPicker('color',hex);
 		$('#' + id + '.of-color').css(hex);
 	  //$('#' + id + '.of-color').val('#000000');
 		$('#' + id + '.of-color').change(hex);
    }
}); //end document ready
